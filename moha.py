...
\033[1;92m╰╯╱╰┻╯╰┻━━┻╯╰┻━━┻╯╱╰━━━┻━━┻━━┻━━╯                                            
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER   : Mohnad
\033[1;91m➣ Github  : https://github.com/HackerBoss
\033[1;91m➣ GANG    : PMF 420 GANG
\033[1;91m➣ Youtube : mohnadha
\033[1;91m➣ WhatsApp: 0914901815
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def Token_token():
	...
	print("")
	try:
		tok = open('/sdcard/Download/.bilal.txt', 'r').read()
		dec = base64.b64decode(tok)
		if len(dec) < 50:
		    not_reg()
		r = requests.get("https://pastebin.com/raw/Ng6eYQgd").text
		if dec in r:
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.Bilal.txt', 'w')
    ...
    print("")
    raw_input("  \t  \033[1;93m Press enter to check again ")
    os.system('xdg-open https://wa.me/+923172716748') #whatsapp number here
    Token_token()
